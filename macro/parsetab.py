...
_lr_productions = [
  ...
  ('expr -> expr PLUS expr','expr',3,'p_add','Dice.py',52),
  ('expr -> expr MINUS expr','expr',3,'p_sub','Dice.py',56),
  ('expr -> MINUS expr','expr',2,'p_expr2uminus','Dice.py',60),
  ('expr -> expr TIMES expr','expr',3,'p_mult_div','Dice.py',64),
  ('expr -> expr DIV expr','expr',3,'p_mult_div','Dice.py',65),
  ('expr -> NUMBER','expr',1,'p_expr2NUM','Dice.py',76),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_parens','Dice.py',80),
]
